...
public class CommandQueryController implements Initializable {
    ...
    private void executeQueryAction(ActionEvent event) {
        System.out.println("cmd - " + cmdTypeBox.getValue());
        System.out.println("cmd file - " + cmdFileBox.getValue());
        System.out.println("visit - " + visitBox.getValue());
        System.out.println("visit value - " + visitValue.getText());
